...
Otomatis saat modal Terbitkan dibuka, **sebelum** apa pun dikirim ke peladen. Yang dipindai adalah
...
Berjalan di Web Worker terpisah supaya modal tidak membeku. Kalau worker gagal dibuat — peramban
...
di pratinjau alih-alih hasil sunting yang salah tempat.
