...
#
# Menjawab pertanyaan: "bagaimana saya tahu JavaScript yang dikirim server
...
#
#   Ini mendeteksi penggantian MENYELURUH — ketika server melayani bundle
#   berbeda kepada semua orang. Ia TIDAK mendeteksi penggantian SELEKTIF, yaitu
#   ketika server melayani bundle jahat hanya kepada satu pengguna yang
