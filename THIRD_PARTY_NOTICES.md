...
Dokumen ini mencantumkan seluruh pustaka, font, dan aset pihak ketiga yang dipakai, beserta
...
**`web-push` (MPL-2.0).** MPL-2.0 adalah copyleft per file. Cloister memakainya sebagai dependensi
...
**`jszip` (MIT atau GPL-3.0-or-later).** Dipakai untuk membangun file ekspor di klien. Kami memilih
opsi MIT.
...
|---|---|---|
| [Open-Meteo](https://open-meteo.com) | Cuaca opsional pada catatan | Dipanggil langsung dari browser, **bukan** lewat server Cloister, supaya koordinat pengguna tidak pernah melewati sistem kami. Fitur ini opsional dan mati secara bawaan |
...
- **Tidak ada layanan analitik atau pelacakan error pihak ketiga.** Alasannya di
