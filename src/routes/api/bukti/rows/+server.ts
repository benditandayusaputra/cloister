 ...
 * transformasi kosmetik. Ini tulang punggung halaman Bukti (PRD 14.3).
 *
 * Aman karena yang dikembalikan adalah ciphertext milik pemanggil sendiri:
 * peladen memang tidak punya bentuk lain untuk diberikan. Kalau suatu hari
...
export const GET: RequestHandler = async (event) =>
	handler(async () => {
		...
		if (!row) throw notFound('Catatan itu belum pernah sampai ke peladen');
