...
Master Key 32B acak
  ...
  `--membungkus--------------&gt; DEK per entri --&gt; ciphertext entri</code></pre>
			...
			<p>
				...
				perangkat atau peramban yang sudah dikompromikan menjadi lingkungan yang tepercaya. Kami
			...
			<p>
				...
				muatan yang dikirim ke peladen, dan baris basis data yang sesungguhnya — berdampingan, dari
