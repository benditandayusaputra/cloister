 ...
 *
 * Prinsip yang dipegang di file ini: **presisi lebih penting daripada
...
/** Koordinat yang masuk akal untuk wilayah Indonesia. */
...
export function pindaiPola(teks: string): Temuan[] {
	...
	kandidat.push(...ambil(teks, RE_EMAIL, 'email', 0.96, 'Alamat email'));
