/**
 * Tindakan penyuntingan yang ditawarkan Penyaring Identitas.
 *
 ...
 * seluruh file ini bekerja pada string dan mengembalikan string baru; tidak
 ...
 * markdown, ia dilewati dan pengguna tetap melihat teks aslinya di preview,
